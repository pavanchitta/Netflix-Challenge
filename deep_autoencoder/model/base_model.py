...
class BaseModel(object):
    ...
    def _init_parameters(self):
        ...
        self.model = tf.keras.Sequential([
            tf.keras.layers.Dense(512, activation=tf.nn.selu, input_shape=(self.FLAGS.num_mov,)),
        ...
        #     self.b1 = tfe.Variable(tf.zeros([512]), name='bias_1')
    ...
    def forward(self, x):
        ...
        #     a6 = tf.nn.selu(tf.matmul(a5, self.W_6))
